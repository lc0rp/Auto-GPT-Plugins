...
| Dolly AutoGPT Cloner | A way to compose & run multiple Auto-GPT processes that cooperate, till core has multi-agent support | [lc0rp/Auto-GPT-Dolly-Plugin](https://github.com/lc0rp/Auto-GPT-Dolly-Plugin)
